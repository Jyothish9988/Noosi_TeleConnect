...
<section class="ftco-intro img" style="background-image: url({{asset('user2/images/bg_2.jpg')}});">
                  ...
                  <div class="card">
                      <div class="card-body">
                          <div class="form-validation">
                              ...
                              <form class="form-valide" action="{{url('consultation_schedule_upload', [ 'bkey' => $bkey])}}"  method="POST">
                              @csrf
